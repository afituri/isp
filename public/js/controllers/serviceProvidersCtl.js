(function(){
  ...
  app.controller('NewServiceProviderCtl',['$scope','$timeout','$state','MenuFac','ServiceProvidersServ','toastr',function($scope,$timeout,$state,MenuFac,ServiceProvidersServ,toastr){
    MenuFac.active = 0;
    $scope.activePanel = MenuFac;
