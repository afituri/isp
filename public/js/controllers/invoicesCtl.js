(function(){
 ...
 app.controller('stCtl',['$scope','PermissionServ','toastr','CustomersServ','$modal','$stateParams','MenuFac','InvoicesServ',function($scope,PermissionServ,toastr,CustomersServ,$modal,$stateParams,MenuFac,InvoicesServ){
